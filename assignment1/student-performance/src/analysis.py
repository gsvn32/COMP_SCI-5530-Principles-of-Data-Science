...
plt.savefig('../results/math_scores.png')
...
plt.savefig('../results/scatter_plot_math_vs_parent_lvl_edu.png')
...
plt.savefig('../results/bxplot_gender_vs_w_score.png')
...
plt.savefig('../results/bar_avg_math_by_race.png')
...
plt.savefig('../results/pie_lunch-type.png')
